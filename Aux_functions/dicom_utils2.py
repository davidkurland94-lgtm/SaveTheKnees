...
# ---------------------------------------------------------------------------
# 6. Read a patient's folder
# ---------------------------------------------------------------------------

def folder_reader(location):
    main_folder = Path(location)
    caminos = [folder for folder in main_folder.iterdir() if folder.is_dir()]
    for camino in caminos :
        #print(describe_series(camino))
        datasets = load_series(camino)
